...
void FlightDataRecorderConverter::writeHeader(ofstream& out, const string& delimiter) {
  ...
  out << "sim.raw.data.psi_magnetic_deg" << delimiter;
  out << "sim.raw.data.psi_true_deg" << delimiter;
  ...
  out << "sim.raw.data.simulation_rate" << delimiter;
  out << "sim.raw.data.ice_structure_percent" << delimiter;
  out << "sim.raw.data.linear_cl_alpha_per_deg" << delimiter;
  out << "sim.raw.data.alpha_stall_deg" << delimiter;
  out << "sim.raw.data.alpha_zero_lift_deg" << delimiter;
  out << "sim.raw.data.ambient_density_kg_per_m3" << delimiter;
  out << "sim.raw.data.ambient_pressure_mbar" << delimiter;
  out << "sim.raw.data.ambient_temperature_celsius" << delimiter;
  out << "sim.raw.data.ambient_wind_x_kn" << delimiter;
  out << "sim.raw.data.ambient_wind_y_kn" << delimiter;
  out << "sim.raw.data.ambient_wind_z_kn" << delimiter;
  out << "sim.raw.data.ambient_wind_velocity_kn" << delimiter;
  out << "sim.raw.data.ambient_wind_direction_deg" << delimiter;
  out << "sim.raw.data.total_air_temperature_celsius" << delimiter;
  out << "sim.raw.data.latitude_deg" << delimiter;
  out << "sim.raw.data.longitude_deg" << delimiter;
...
void FlightDataRecorderConverter::writeStruct(ofstream& out, const string& delimiter, const fbw_output& data) {
  ...
  out << data.sim.raw.data.psi_magnetic_deg << delimiter;
  out << data.sim.raw.data.psi_true_deg << delimiter;
  ...
  out << data.sim.raw.data.simulation_rate << delimiter;
  out << data.sim.raw.data.ice_structure_percent << delimiter;
  out << data.sim.raw.data.linear_cl_alpha_per_deg << delimiter;
  out << data.sim.raw.data.alpha_stall_deg << delimiter;
  out << data.sim.raw.data.alpha_zero_lift_deg << delimiter;
  out << data.sim.raw.data.ambient_density_kg_per_m3 << delimiter;
  out << data.sim.raw.data.ambient_pressure_mbar << delimiter;
  out << data.sim.raw.data.ambient_temperature_celsius << delimiter;
  out << data.sim.raw.data.ambient_wind_x_kn << delimiter;
  out << data.sim.raw.data.ambient_wind_y_kn << delimiter;
  out << data.sim.raw.data.ambient_wind_z_kn << delimiter;
  out << data.sim.raw.data.ambient_wind_velocity_kn << delimiter;
  out << data.sim.raw.data.ambient_wind_direction_deg << delimiter;
  out << data.sim.raw.data.total_air_temperature_celsius << delimiter;
  out << data.sim.raw.data.latitude_deg << delimiter;
  out << data.sim.raw.data.longitude_deg << delimiter;
