...
void FlyByWireModelClass::step()
{
  ...
  FlyByWire_DWork.Delay1_DSTATE = 1.0 / rtb_Limiterxi1 * (FlyByWire_P.Constant_Value_c - rtb_Limiterxi) *
  ...
  u0 = u1 - FlyByWire_DWork.Delay_DSTATE_a;
  ...
  u0 = FlyByWire_B.flare_Theta_c_deg - FlyByWire_DWork.Delay_DSTATE_h;
  ...
  u0 = result_tmp - FlyByWire_DWork.Delay_DSTATE_d;
  ...
  if (FlyByWire_DWork.Delay_DSTATE_d <= rtb_Sum5) {
    ...
    if (FlyByWire_DWork.Delay_DSTATE_d >= rtb_Sum5) {
      rtb_Sum5 = FlyByWire_DWork.Delay_DSTATE_d;
    }
  }
  ...
  if (rtb_in_flare > FlyByWire_P.Switch_Threshold) {
    rtb_Limiterxi = (FlyByWire_DWork.Delay_DSTATE_h - rtb_GainTheta) * FlyByWire_P.Gain_Gain;
  ...
  if (rtb_GainPhi > FlyByWire_P.Saturation_UpperSat_d) {
    ...
    rtb_Gain_g = FlyByWire_P.Saturation_LowerSat_p;
  } else {
    rtb_Gain_g = rtb_GainPhi;
  }

  rtb_Sum5 = (std::cos(FlyByWire_P.Gain1_Gain_p * rtb_GainTheta) / std::cos(FlyByWire_P.Gain1_Gain_b * rtb_Gain_g) +
  ...
  rtb_Gain_g = rtb_Limiterxi * look1_binlxpw(FlyByWire_U.in.data.V_tas_kn, FlyByWire_P.DLUT_bp01Data,
    FlyByWire_P.DLUT_tableData, 1U) * FlyByWire_P.DiscreteDerivativeVariableTs_Gain;
  rtb_Limiterxi = (rtb_Gain_g - FlyByWire_DWork.Delay_DSTATE_i) / FlyByWire_U.in.time.dt + rtb_Limiterxi * look1_binlxpw
  ...
  if (FlyByWire_DWork.icLoad != 0) {
    ...
    FlyByWire_DWork.Delay_DSTATE_f = u1 - rtb_Limitereta;
  }
  ...
  if (FlyByWire_DWork.Delay_DSTATE_a > FlyByWire_P.Saturation_UpperSat_f) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_f;
  } else if (FlyByWire_DWork.Delay_DSTATE_a < FlyByWire_P.Saturation_LowerSat_pq) {
    rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_pq;
  } else {
  ...
  u0 = FlyByWire_DWork.Delay_DSTATE_m - FlyByWire_DWork.Delay_DSTATE_p;
  ...
  u0 = rtb_Limitereta - FlyByWire_DWork.Delay_DSTATE_dj;
  ...
  FlyByWire_DWork.Delay_DSTATE_dj += rtb_Limiterxi1;
  ...
  rtb_Limitereta = u0 * FlyByWire_DWork.Delay_DSTATE_dj;
  ...
  u0 = rtb_BusAssignment_a_sim_input_delta_zeta_pos - FlyByWire_DWork.Delay_DSTATE_c;
  ...
  FlyByWire_DWork.Delay_DSTATE_c += u1;
  ...
  rtb_Limiterxi = (FlyByWire_P.Gain5_Gain * FlyByWire_DWork.Delay_DSTATE_c + u0) * FlyByWire_DWork.Delay_DSTATE_dj +
    rtb_Limiterxi1;
  ...
  if (FlyByWire_DWork.Delay_DSTATE_dj > FlyByWire_P.Saturation_UpperSat_i) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_i;
  } else if (FlyByWire_DWork.Delay_DSTATE_dj < FlyByWire_P.Saturation_LowerSat_b) {
  ...
  rtb_Limitereta = FlyByWire_P.Constant_Value_hh - rtb_Limitereta;
  ...
  } else if (FlyByWire_DWork.Delay_DSTATE_dj < FlyByWire_P.Saturation_LowerSat_n) {
    rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_n;
  } else {
    rtb_Limitereta = FlyByWire_DWork.Delay_DSTATE_dj;
  }

  rtb_Limiterxi *= rtb_Limitereta;
  rtb_Limitereta = FlyByWire_P.Constant_Value_gt - rtb_Limitereta;
  rtb_Limitereta *= BusAssignment_roll_data_computed_delta_zeta_deg;
  rtb_Limiterxi += rtb_Limitereta;
  u0 = rtb_BusAssignment_m_pitch_output_eta_deg - FlyByWire_DWork.Delay_DSTATE_p5;
  ...
  FlyByWire_DWork.Delay_DSTATE_p5 += rtb_Limiterxi1;
  u0 = rtb_Sum5 - FlyByWire_DWork.Delay_DSTATE_hb;
  ...
  FlyByWire_DWork.Delay_DSTATE_hb += rtb_Limiterxi1;
  u0 = rtb_Limiterxi - FlyByWire_DWork.Delay_DSTATE_au;
  ...
  FlyByWire_DWork.Delay_DSTATE_au += rtb_Limiterxi1;
  ...
  u0 = FlyByWire_P.Gaineta_Gain_d * FlyByWire_DWork.Delay_DSTATE_p5;
  ...
  u0 = FlyByWire_P.GainiH_Gain * FlyByWire_DWork.Delay_DSTATE_p;
  ...
  u0 = FlyByWire_P.Gainxi_Gain_n * FlyByWire_DWork.Delay_DSTATE_hb;
  ...
  u0 = FlyByWire_P.Gainxi1_Gain_e * FlyByWire_DWork.Delay_DSTATE_au;
  ...
  FlyByWire_Y.out.pitch.data_computed.in_flight_gain = FlyByWire_DWork.Delay_DSTATE_a;
  ...
  FlyByWire_Y.out.pitch.data_computed.flare_Theta_c_deg = FlyByWire_DWork.Delay_DSTATE_h;
  ...
  FlyByWire_Y.out.pitch.output.eta_trim_deg = FlyByWire_DWork.Delay_DSTATE_p;
  ...
  FlyByWire_DWork.Delay_DSTATE_i = rtb_Gain_g;
...
void FlyByWireModelClass::initialize()
{
  ...
  FlyByWire_DWork.Delay_DSTATE_k = FlyByWire_P.Delay_InitialCondition_o;
  FlyByWire_DWork.Delay1_DSTATE = FlyByWire_P.Delay1_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_a = FlyByWire_P.RateLimiterVariableTs_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_h = FlyByWire_P.RateLimiterDynamicVariableTs_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_d = FlyByWire_P.RateLimiterVariableTs_InitialCondition_c;
  FlyByWire_DWork.Delay_DSTATE_i = FlyByWire_P.DiscreteDerivativeVariableTs_InitialCondition;
  FlyByWire_DWork.icLoad = 1U;
  FlyByWire_DWork.Delay_DSTATE_p = FlyByWire_P.RateLimiterDynamicVariableTs_InitialCondition_i;
  FlyByWire_DWork.icLoad_b = 1U;
  ...
  FlyByWire_DWork.Delay_DSTATE_p5 = FlyByWire_P.RateLimitereta_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_hb = FlyByWire_P.RateLimiterxi_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_au = FlyByWire_P.RateLimiterzeta_InitialCondition;
