...
struct Parameters_Autopilot_T_ {
  ...
  real_T ScheduledGain_BreakpointsForDimension1_dc[4];
  real_T LagFilter_C1;
  ...
  real_T Gain2_Gain_d;
  real_T Gain1_Gain_i;
  real_T Gain1_Gain_jw;
  real_T kntoms_Gain_c;
  real_T msftmin_Gain_h;
  real_T ftmintoms_Gain_lx;
  real_T IC_Value_a;
  real_T Gain_Gain_ig;
  real_T Gain_Gain_nm;
